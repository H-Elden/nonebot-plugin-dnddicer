...
import pytest
from nonebot_plugin_dnddicer.engine.roll.ast_engine.trace import (
    EvaluationTrace,
    DiceRollEvent,
...
from nonebot_plugin_dnddicer.engine.roll.ast_engine.errors import (
    RollLimitError,
    RollErrorCode,
)
from nonebot_plugin_dnddicer.engine.roll.ast_engine.limits import (
    SafetyLimits,
    LimitChecker,
...
class TestModifierRendering:
    ...
    def test_render_modifier_replace_sentinel_handled(self):
        ...
        renderer = LegacyTextRenderer()
        from nonebot_plugin_dnddicer.engine.roll.ast_engine.trace import EvaluationTrace, DiceRollEvent
...
class TestEvaluationDepthLimit:
    ...
    def test_normal_depth_no_error(self):
        ...
        from nonebot_plugin_dnddicer.engine.roll.ast_engine.parser import parse_expression
        from nonebot_plugin_dnddicer.engine.roll.ast_engine.evaluator import evaluate
    ...
    def test_depth_limit_exceeded_raises_limit_error(self):
        ...
        from nonebot_plugin_dnddicer.engine.roll.ast_engine.parser import parse_expression
        from nonebot_plugin_dnddicer.engine.roll.ast_engine.evaluator import Evaluator
        from nonebot_plugin_dnddicer.engine.roll.ast_engine.errors import RollLimitError
        from nonebot_plugin_dnddicer.engine.roll.ast_engine.limits import SafetyLimits
