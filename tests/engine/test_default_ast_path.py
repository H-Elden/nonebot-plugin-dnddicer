...
from nonebot_plugin_dnddicer.engine.roll.ast_engine.adapter import exec_roll_exp_unified
...
class TestDefaultPathIsAST:
    ...
    def test_ast_error_becomes_roll_dice_error(self):
        ...
        with patch(
            'nonebot_plugin_dnddicer.engine.roll.ast_engine.adapter.exec_roll_exp_ast',
    ...
    def test_unexpected_ast_error_wraps_as_roll_dice_error(self, error_cls, monkeypatch):
        ...
        from nonebot_plugin_dnddicer.engine.roll.ast_engine import adapter
        from nonebot_plugin_dnddicer.engine.roll.roll_utils import RollDiceError
...
class TestComputeExpAstPath:
    ...
    def test_sample_roll_exp_ast_returns_int(self):
        from nonebot_plugin_dnddicer.engine.roll.ast_engine import sample_roll_exp_ast
...
class TestIsRollExp:
    ...
    def test_plain_text_returns_false(self):
        ...
        from nonebot_plugin_dnddicer.engine.roll.ast_engine.adapter import is_roll_exp
