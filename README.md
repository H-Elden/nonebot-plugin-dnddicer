...
>
> ⚠️ **当前状态：开发中（里程碑 1「项目骨架」已完成）** —— 骨架已可按商店合规标准被
> NoneBot 正确加载；掷骰引擎与各功能模块按下列路线图逐步落地中。
...
| 指令 | 说明 | 状态 |
| --- | --- | --- |
| `.r` / `.rh` | 掷骰表达式 / 暗骰（引擎移植） | 🚧 规划中 |
| `.st` / `.角色卡` 系列 | 六属性建卡、检定/豁免/攻击、`.dnd` 属性生成 | 🚧 规划中 |
| `.hp` | HP 管理 | 🚧 规划中 |
| `.init` / `.先攻` | 先攻列表 | 🚧 规划中 |
...
3. ⏳ **第一期**：掷骰、角色卡与检定、HP、先攻、战斗轮（简化版）、群配置、帮助
