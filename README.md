...
>
> 当前版本：**v0.4.1** · 完整使用手册见 **📖 [使用文档](https://h-elden.github.io/nonebot-plugin-dnddicer/)**（[国内镜像](https://dnddicer.netlify.app/)，GitHub Pages 访问不畅时用）
...
8. ⏳ **第二期余下**：牌堆/随机表；
9. ⏳（可选）**T3 增强期**：法术位管理（`.ss/.cast`）、死亡豁免闭环（`.ds`）、BUFF/临时加值表（`.buff`）等。
